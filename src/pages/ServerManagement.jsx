  ...
  return (
    <div className="fixed left-0 right-0 z-40 overflow-y-auto custom-scrollbar bg-[var(--bg-main)]" style={{ top: 'var(--total-header)', bottom: 'var(--bottom-nav)' }}>
      ...
      {currentFolders.length === 0 && currentServers.length === 0 ? (
        <div className="glass-card py-24 md:py-48 px-6 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-2xl md:text-3xl font-black uppercase tracking-tight mb-4 font-display">No nodes detected in scope</h3>
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-8">
           ...
           <div className="glass-card w-full max-w-lg p-6 sm:p-10 relative z-10">
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative group">
                      <pre className="bg-black/60 p-4 sm:p-8 rounded-3xl text-xs text-gray-300 font-mono leading-relaxed overflow-x-auto border border-white/5 group-hover:border-[var(--accent-violet)]/30 transition-all">
                        {installCommand}
                      </pre>
      ...
      {showFolderModal && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-8">
           ...
           <div className="glass-card w-full max-w-sm p-6 sm:p-10 relative z-10">
      ...
      {showMoveModal && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-8">
           ...
           <div className="glass-card w-full max-w-sm p-6 sm:p-10 relative z-10 text-center">
